$(document).ready(function(){
	//	
	 ...
	 $(".instagram").mouseover(function(){
	     $('body').css('background-image', 'url(image/instagram.png)');
	     $("#quote").text("Or check out my latest pics!");
	 });
	 ...
	 $(".linkedin").mouseover(function(){
	     $('body').css('background-image', 'url(image/linkedin.png)');
	     $("#quote").text("Or even hire me!");
	 });
